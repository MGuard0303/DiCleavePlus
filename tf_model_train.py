...
union_fusion_sequence = dmodel.AttentionalFeatureFusion(glo_pool_size=(200, HID_FEA), pool_type=2)
union_fusion_pattern = dmodel.AttentionalFeatureFusion(glo_pool_size=(14, HID_FEA), pool_type=2)
